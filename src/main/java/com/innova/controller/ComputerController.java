...
public class ComputerController {
    ...
    // http://localhost:8080/computer/create2?computer_name=computeradim55&computer_trade=xyzmarkasi&computer_price=66
    ...
    //SELECT
    // http://localhost:8080/computer/select/minprice/76
